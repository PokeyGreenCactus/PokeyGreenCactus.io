...
function loadContent() {
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 
      ...
      newConfirmedOver1000 = _.orderBy(newConfirmedOver1000, "TotalConfirmed", "desc");
...
for (let i=0; i<covidJsObj.Countries.length; i++) {
  newArray.push({
    ...
    "TotalDeaths": covidJsObj.Countries[i].TotalConfirmed,
    "Population": numPopArr[i],
    "TotalConfirmedPer100000": Number.parseInt(covidJsObj.Countries[i].TotalConfirmed)/Number.parseInt(numPopArr[i]) * 100000,
  })
